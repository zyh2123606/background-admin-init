...
import { useHistory, connect, useDispatch } from 'umi'
...
const UpdatePwd: React.FunctionComponent<IProps> = ({ pwdVisible, account = { user: {} }, loading }) => {
	...
	return (
		<Modal
			...
			onCancel={hideWin}
			footer={[
				<Button key="back" onClick={hideWin}>取消</Button>,
				<Button
					key="submit"
					type="primary"
					disabled={loading}
